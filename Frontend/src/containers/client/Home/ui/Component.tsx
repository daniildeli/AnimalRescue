...
export const HomePageMain = (props: IPropTypes) => {
  useEffect(() => {
    props.fetchSickAnimals();
    props.fetchAnimalsRequest();
    props.fetchAnimalsRequest(AnimalKind.DOG);
    props.fetchAnimalsRequest(AnimalKind.CAT);
    props.fetchBlogList(AllTag.SAVED);
    props.fetchSavedAnimalsCount();
  }, []);
    ...
    <React.Fragment>
      ...
      <div className="home-page-client">
        ...
        <CounterBlock
          ...
          count={props.savedAnimalsCount.data}
        ...
        <div className="animal-list-wrapper">
          ...
          />}
          {props.catsList.data.length > 0 && <AnimalsList
            data={props.catsList.data}
        ...
        <HelpBlock
          animalsList={props.sickAnimalsList}
